      ...
      <div className="flex flex-col h-full">
        <Header>
          <Button variant="ghost" asChild>
              <Link href="/insurance-quotes/dashboard">Back to Dashboard</Link>
          </Button>
        </Header>
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Button asChild className="mt-4">
              <Link href="/insurance-quotes/dashboard">Go to Dashboard</Link>
            </Button>
          </div>
        </main>
      </div>
  ...
  return (
    <div className="flex flex-col h-full">
       <Header>
          ...
          {isEditable && (
            <Button asChild>
                <Link href={`/quote/${quote.id}/edit`}><Edit/>Edit Quote</Link>
            </Button>
          )}
      </Header>
      <main className="flex-1 overflow-y-auto">
