...
export default function PrintBmtQuotePage() {
  ...
  useEffect(() => {
    ...
    const {
        ...
        const selectedHull = { name: `${quote.selectedMaterial} ${quote.modelName}`, price: hullPrice, includesGst: hullPricing?.includesGst || false, imageUrl: selectedColor?.images?.[0]?.url };
