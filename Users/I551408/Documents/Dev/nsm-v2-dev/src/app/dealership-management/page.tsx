...
function DealerManagementPageContent({ logo, onLogoChange }: { logo: string | null, onLogoChange: (newLogo: string) => void }) {
    return (
                ...
                <CardContent className="flex flex-col items-center gap-4">
                    {logo && (
                        <div className="w-48 p-4 border rounded-md">
                            <Image src={logo} alt="Current company logo" width={200} height={100} className="object-contain" />
                        </div>
                    )}
                    <LogoUploader onLogoUploaded={onLogoChange} />
                </CardContent>
            </Card>
        </main>
    );
  ...
  return (
     ...
     >
        ...
        <div className="flex flex-col h-screen">
             ...
             <DealerManagementPageContent logo={logo} onLogoChange={setLogo} />
        </div>
    </SidebarProvider>
  );
}
